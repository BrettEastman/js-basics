...
console.log(thisFunc.call(red, green, blue));
// { color: 'red', method: [Function: thisFunc] } { color: 'green' } { color: 'blue' }

var yellow = {color: "yellow"};

console.log(red.method.call(yellow, green, blue));
// { color: 'yellow' } { color: 'green' } { color: 'blue' }

console.log(setTimeout(red.method, 1000));
